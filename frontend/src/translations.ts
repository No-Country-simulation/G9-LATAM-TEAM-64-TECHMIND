...
export const DICT = {
  es: {
    ...
    "analyzer.fileHint": "Sustituye al texto pegado.",
    "analyzer.fileFormats": "TXT, PDF o DOCX",
    "analyzer.fileMaxSize": "hasta 10 MB",
  ...
  en: {
    ...
    "analyzer.fileHint": "Replaces the pasted text.",
    "analyzer.fileFormats": "TXT, PDF or DOCX",
    "analyzer.fileMaxSize": "up to 10 MB",
